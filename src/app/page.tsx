    ...
    <Suspense fallback={<LoadingPage />}>
      <main className="flex min-h-screen flex-col w-full bg-zinc-100 snap-y snap-proximity overflow-x-clip">
        <div className="flex w-full min-h-screen snap-start" ref={startDiv} id="startSection"  >
          ...
          <div className="grid grid-cols-5 h-12 items-center justify-center py-2 text-sm 2xl:text-lg lg:text-lg">
          ...
          <div className="flex w-full -translate-y-8">
            <MaxWidthWrapper>
                <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 w-full gap-8 transition-all duration-500 ease-in-out">
                  ...
                  <div className="flex flex-col lg:col-span-2 2xl:col-span-1 w-full text-2xl items-center justify-center  p-8 rounded-2xl border-2 border-cyan-500/60  hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-500 ease-in-out">
                    <AvatarList />
                  </div>
