        ...
        <div className="flex flex-col h-full">
          <div className="flex w-full justify-center">
            <Image
              ...
              width={1000}
              height={1000}
              className="w-44 h-44 2xl:w-72 2xl:h-72  drop-shadow-[5px_5px_8px_#02a9ac]"
            />
          </div>
          <div className="flex flex-col w-full ">
            ...
            <p className="flex px-2 2xl:px-4 text-sm font-normal items-start text-white/50 text-pretty ">
              Sneakers Running Shoes Colors The above sneakers running shoes
              color PNG image is designed by our dedicated and professional
              designers.
            </p>
          </div>
          ...
          <div className="flex w-full py-4 px-2 2xl:px-4 text-sm font-semibold text-white ">
            <div className="flex w-fit  rounded-2xl bg-slate-500 text-slate-950 cursor-pointer">
              <h1 className="px-2 py-1 text-white">Buy</h1>
