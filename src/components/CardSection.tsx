...
const CardSection = () => {
  return (
    <div className="flex flex-col 2xl:flex-row lg:flex-row w-full mt-16 gap-4 space-y-4  2xl:mt-24">
      <div className="flex flex-col w-full  items-start justify-center relative">
        <motion.div
          initial={{ left: "100%", opacity: 0 }}
          whileInView={{ left: 0, opacity: 1 }}
          transition={{ duration: 1.5, ease: "circInOut", delay: 2.9 }}
          className="absolute rounded-lg left-0 top-0 h-full w-2 bg-gradient-to-b from-orange-500 via-yellow-500 to-orange-500"
        />
        <div className="flex flex-row px-6 w-full gap-2 2xl:gap-4 items-center fill-black dark:fill-white">
          <svg
            className="w-[60px] h-[60px] 2xl:w-[85px] 2xl:h-[85px] "
          ...
          >
            ...
            <g
              ...
              stroke="#050505"
              strokeWidth="5.8459200000000004"
            >
              {" "}
              <g>
                {" "}
