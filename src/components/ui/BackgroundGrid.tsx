...
export function GridBackgroundDemo({
  ...
  return ( 
    <div className={cn("h-auto w-full dark:bg-black bg-zinc-100  dark:bg-dot-orange-500/[0.5] bg-dot-orange-500/[0.5] relative flex items-center justify-center",className)}>
