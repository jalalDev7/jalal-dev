  ...
  return (
    <main className="flex flex-col w-full items-center justify-center gap-8 px-4 text-orange-500 mb-16">
      ...
      <ul className="steps font-medium">
        ...
        <li className={`step ${step > 1 ? "step-warning " : null}`}>
          Get comments from link
        </li>
        <li className={`step ${step > 2 ? "step-warning " : null}`}>
          Pick winners
        </li>
      </ul>
      <div className="mockup-window border bg-base-300 lg:w-[80%] w-full relative">
        {step === 1 ? (
              ...
              <div className=" flex flex-col w-full gap-2 items-center justify-center">
                <div className="flex flex-col w-full items-start justify-start">
                  ...
                  <p className="text-sm font-medium text-neutral-400 mt-2">
                    You can use any valable youtube video link to get all
                    comments and pick winners.
                  </p>
                  <p className="text-sm font-medium text-neutral-400 mb-2">
                    Demo link: https://www.youtube.com/watch?v=f9nHclaqbRI&t=2s
                  </p>
                </div>
                ...
                <button
                  className="bg-[#7480FF] text-white font-semibold px-4 py-2 w-fit rounded-lg mt-4"
